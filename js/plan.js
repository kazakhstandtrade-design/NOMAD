...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function filterJourneys() {
        ...
        /*
         СТРАНА — ОБЯЗАТЕЛЬНЫЙ ФИЛЬТР.

         Другие страны никогда не попадут
         в результаты выбранной страны.
        */
        ...
        /*
         Если дополнительные фильтры
         ничего не нашли — показываем
         маршруты только выбранной страны.
        */
